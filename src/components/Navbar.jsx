...
const NavButton = ({title, customFunc, icon, color, dotColor}) => (
  <TooltipComponent content={title} position="BottomCenter">
    <button type="button" onClick={customFunc} style={{color}} className="relative text-x1 rounded-full p-3 hover:bg-light-gray">
  ...
  return (
    <div className="flex justify-between p-2 md:mx-6 relative">
      ...
      <div className="flex">
        ...
        <NavButton title="Chart" dotColor="#03C9D7" customFunc={()=>handleClick('chat')} color= {currentColor} icon={<BsChatLeft/>}/>
        ...
        <TooltipComponent content="Ptofile" position="BottomCenter">
