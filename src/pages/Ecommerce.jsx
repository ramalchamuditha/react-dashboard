            ...
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className="p-1.5 hover:drop-sahdow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 text-xs">23%</span>
                </p>
              ...
              <div className="mt-5">
                <SparkLine currentColor= {currentColor} id="line-sparkline" type="Line" data={SparklineAreaData} height="80px" width="250px" color= {currentColor} />
              </div>
              <div className="mt-10">
